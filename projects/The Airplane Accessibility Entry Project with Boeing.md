---
layout: default
title: The Airplane Accessibility Entry Project with Boeing
---
...
Engineering analysis and physical testing validated key safety and usability requirements. The wheelchair supported a 250 lb load without structural failure, and the backrest sustained an 87 lbf aft load corresponding to the maximum expected force exerted by a 250 lb occupant leaning on the backrest. A propelling test confirmed that less than 12 lbf per hand was required to initiate motion from a standstill, a force level achievable by a 5th percentile adult female. Additionally, radial-load testing of the lifting linear actuators demonstrated actuator deflections well below those that could result in the wheelchair tipping while in the aisle configuration. Overall, the results demonstrate that the proposed design meets critical structural, functional, and accessibility requirements for a 250 lb user within standard commercial aircraft constraints. This work represents a meaningful improvement in accessibility by reducing required transfers, minimizing the risk of wheelchair damage, and preserving user independence during air travel.
